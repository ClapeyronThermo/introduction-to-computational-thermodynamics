...
# ╔═╡ 918d9117-8ff5-4d69-aa9d-f7612121a071
using ForwardDiff

# ╔═╡ d37e8f21-b8f5-44bb-8e96-fafdceb88715
# begin
# 	using ForwardDiff
# 	using PlutoUI
...
# ╔═╡ 6f10eae1-952e-4b92-8df8-c058c14db173
md"""
...
# ╔═╡ 08954f34-e892-4cc9-8275-1ca32a50151d
ForwardDiff.derivative(f, 3)

# ╔═╡ f354b1fc-56d2-43b1-a0bc-3927bc31c490
hint(text) = Markdown.MD(Markdown.Admonition("hint", "Hint", [text]));

# ╔═╡ e5409459-8743-4f63-88db-88bf8fe17175
almost(text) = Markdown.MD(Markdown.Admonition("warning", "Almost there!", [text]));

# ╔═╡ bfa1114f-6fff-4df5-97dd-5cf46e8264c1
still_missing(text=md"Replace `missing` with your answer.") = Markdown.MD(Markdown.Admonition("warning", "Here we go!", [text]));

# ╔═╡ d69119fe-e54e-4e8b-96e7-e1e738c1c603
keep_working(text=md"The answer is not quite right.") = Markdown.MD(Markdown.Admonition("danger", "Keep working on it!", [text]));

# ╔═╡ 1a37007e-a954-4dca-a1de-17fe4d59d99e
yays = [md"Fantastic!", md"Splendid!", md"Great!", md"Yay ❤", md"Great! 🎉", md"Well done!", md"Keep it up!", md"Good job!", md"Awesome!", md"You got the right answer!", md"Let's move on to the next section."];

# ╔═╡ c1a55bff-ecfb-43f8-8671-09310338fe78
correct(text=rand(yays)) = Markdown.MD(Markdown.Admonition("correct", "Got it!", [text]));

# ╔═╡ 9cbc38b6-c986-4654-bd9d-feb7686358da
...
julia_version = "1.8.0"
manifest_format = "2.0"
project_hash = "622dd3c2b805e91d060718ba579e257cf8116129"
